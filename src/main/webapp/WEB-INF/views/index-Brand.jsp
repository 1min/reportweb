...
<body>
  <div id="wrap">
    ...
    <section id="Brand-Company">
      <div class="Brand">
        <ul class="nav flex-column company_index">
          <li class="nav-item Brand_index_1">
            <a class="nav-link active" href="#">Our Brand</a>
          </li>
        </ul>
      </div>
      <div class="article_company">
        <div class="Brand_index_1_contents">
          TM Container SUPPLIES HIGH QUALITY CONTAINERS AND SERVICE WITH COMPETITIVE PRICING.
          <br> WHY BE SATISFIED WITH LESS?
        </div>
      </div>
